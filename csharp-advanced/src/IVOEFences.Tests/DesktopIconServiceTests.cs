...
public class AppSettingsRepositoryTests : IAsyncLifetime
{
    ...
    {
        _tempDir = Path.Combine(Path.GetTempPath(), $"ivoefences-appsettings-tests-{Guid.NewGuid():N}");
    ...
    public async Task SaveNow_ThenLoadAsync_PreservesUpdatedValues()
    {
        ...
        _service.Current.FenceOpacity = 73;
        _service.SaveNow();
        ...
        _service.Current.FenceOpacity.Should().Be(73);
    }
