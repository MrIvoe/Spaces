...
/// <summary>
/// Manages tab state and switching for multi-page spaces.
/// 
/// When a space has TabContainerId set, it belongs to a tabbed group.
...
/// </summary>
public sealed class SpaceTabManager
{
    ...
    /// <summary>Current active tab name (space title or custom tab name).</summary>
    public string CurrentTabName => _model.Title;

    /// <summary>Is this space part of a tabbed container?</summary>
    public bool IsTabbed => _model.TabContainerId.HasValue;

    public SpaceTabManager(SpaceModel model)
    {
        _model = model;
    ...
    /// <summary>Toggle tab visibility (for single-tab or multi-tab spaces).</summary>
