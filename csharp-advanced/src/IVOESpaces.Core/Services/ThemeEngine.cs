...
public sealed class ThemeEngine
{
    ...
    public sealed record ThemePalette
    {
        ...
        // Spaces
        public Color SpaceBackground { get; init; } = Color.FromArgb(232, 232, 232);
        public Color SpaceTitleBackground { get; init; } = Color.FromArgb(0, 120, 212);
        public Color SpaceTitleForeground { get; init; } = Color.FromArgb(255, 255, 255);
        public Color SpaceBorder { get; init; } = Color.FromArgb(197, 197, 197);
    }
    ...
    public Dictionary<string, string> GetColorPalette()
    {
        ...
        return new Dictionary<string, string>
        {
            ...
            { "SpaceBackground", ToHex(p.SpaceBackground) },
            { "SpaceTitleBackground", ToHex(p.SpaceTitleBackground) },
            { "SpaceTitleForeground", ToHex(p.SpaceTitleForeground) },
            { "SpaceBorder", ToHex(p.SpaceBorder) },
        };
    }
    ...
    private static readonly ThemePalette DarkPalette = new()
    {
        ...
        SpaceBackground = Color.FromArgb(45, 45, 45),
        SpaceTitleBackground = Color.FromArgb(0, 120, 212),
        SpaceTitleForeground = Color.FromArgb(255, 255, 255),
        SpaceBorder = Color.FromArgb(64, 64, 64),
    };
    ...
    private static readonly ThemePalette HighContrastPalette = new()
    {
        ...
        SpaceBackground = Color.FromArgb(0, 0, 0),
        SpaceTitleBackground = Color.FromArgb(255, 255, 0),
        SpaceTitleForeground = Color.FromArgb(0, 0, 0),
        SpaceBorder = Color.FromArgb(255, 255, 255),
    };
