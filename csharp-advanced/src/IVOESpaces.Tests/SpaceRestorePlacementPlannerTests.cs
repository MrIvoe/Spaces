...
public class SpaceRestorePlacementPlannerTests
{
    [Fact]
    public void Plan_UsesResolvedMonitorArea_WhenNamedMonitorIsAvailable()
    {
        var planner = new SpaceRestorePlacementPlanner((string deviceName, out Win32.RECT workArea) =>
        {
        ...
        SpaceRestorePlacementPlanner.PlacementPlan plan = planner.Plan(model, new Win32.RECT { left = 0, top = 0, right = 500, bottom = 400 });
    ...
    public void Plan_FallsBackAndClamps_WhenStoredMonitorIsUnavailable()
    {
        ...
        SpaceRestorePlacementPlanner.PlacementPlan plan = planner.Plan(model, new Win32.RECT { left = 0, top = 0, right = 1000, bottom = 800 });
    ...
    public void Plan_ComputesDockedBarBounds_FromTargetArea()
    {
        ...
        SpaceRestorePlacementPlanner.PlacementPlan plan = planner.Plan(model, new Win32.RECT { left = 0, top = 0, right = 100, bottom = 100 });
