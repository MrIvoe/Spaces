...
internal sealed class SpaceRestorePlacementPlanner
{
    ...
    public SpaceRestorePlacementPlanner(TryResolveMonitorWorkArea? workAreaResolver = null)
    {
        _workAreaResolver = workAreaResolver ?? TryGetWorkAreaByDeviceNameFromSystem;
    }

    internal PlacementPlan Plan(SpaceModel model, Win32.RECT fallbackWorkArea)
    {
