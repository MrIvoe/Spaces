...
/// Fences reference entities; files remain in their native filesystem locations.
/// </summary>
public sealed class DesktopEntityRegistryService
{
    ...
    public void AssignToFence(Guid entityId, Guid fenceId)
    {
        lock (_lock)
        {
            ...
            entity.Ownership = DesktopItemOwnership.FenceManaged;
            entity.OwnerFenceId = fenceId;
