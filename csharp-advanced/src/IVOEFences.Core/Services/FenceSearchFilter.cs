...
/// <summary>
/// Live search/filter for fence items using fuzzy matching.
/// 
/// Features:
...
/// </summary>
public sealed class FenceSearchFilter
{
    private string _query = string.Empty;
    private List<FenceItemModel>? _filteredCache;
    ...
    public IReadOnlyList<FenceItemModel> GetFilteredItems(IReadOnlyList<FenceItemModel> allItems)
    {
        if (!IsActive)
            return allItems;
