...
enum class PluginCapability : uint32_t {
    ...
    SpaceSettingsPage       = 1 << 2,       // Can provide per-space settings
    SpaceViewProvider       = 1 << 3,       // Can provide custom space content view
    RenderHook              = 1 << 4,       // Can hook into space render pipeline
