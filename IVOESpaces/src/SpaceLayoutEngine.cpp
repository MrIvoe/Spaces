...
std::vector<SpaceLayoutEngine::ItemSlot> SpaceLayoutEngine::BuildListLayout(
...
int SpaceLayoutEngine::HitTest(const std::vector<ItemSlot>& slots, POINT clientPoint) const {
